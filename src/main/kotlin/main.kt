fun main() {
    ...
    println("Day 1")
    println("\tExercise 1: ${getDay1Exercise1Result()}")
    println("\tExercise 2: ${getDay1Exercise2Result()}")
    println("")
    println("Day 2")
