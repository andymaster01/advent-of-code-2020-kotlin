...
class Day2SecondTakeTests {

    @Test
    fun `true when min position is valid`(){
        val sut = Day2()
        val input = StringParsedResult(true, 1, 3, 'a', "abc")
    ...
    fun `false when min position is invalid`(){
        val sut = Day2()
        val input = StringParsedResult(true, 1, 3, 'a', "bce")
    ...
    fun `true when max position is valid`(){
        val sut = Day2()
        val input = StringParsedResult(true, 1, 3, 'a', "bca")
    ...
    fun `false when max position is invalid`(){
        val sut = Day2()
        val input = StringParsedResult(true, 1, 3, 'a', "bcd")
